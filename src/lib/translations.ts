export const translations = {
  pl: {
    ...
    'maxCreatorsDescription': 'Podczas kręcenia losowo wybierz tylu twórców z listy. Pozostaw puste lub ustaw 0, aby pokazać wszystkich twórców. Jeśli masz mniej twórców niż ta liczba, wszyscy będą pokazani.',
    ...
    'rigDescription': 'Gdy ustawione, koła będą kręcić się normalnie, ale zawsze zatrzymają się na wybranym twórcy.',
    ...
    'bulkImportPlaceholder': 'Wpisz nazwy użytkowników, po jednej w linii\nPrzykład:\ntwórca1\ntwórca2\ntwórca3',
    'bulkImportDescription': 'Wklej wiele nazw użytkowników, po jednej w linii. Adresy URL YouTube zostaną wygenerowane automatycznie.',
